...
def price():
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="60",
        fg="#ED420B", anchor=W)
        lblinfo.grid(row=1, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Burger King",
        fg="#ED420B", anchor=W)
        lblinfo.grid(row=2, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="79",
        fg="#ED420B", anchor=W)
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="199",
        fg="#ED420B", anchor=W)
...
heading2=Label(root,text="Nida Restaurant ",font="arial 18 bold",fg="#fc5a03")
